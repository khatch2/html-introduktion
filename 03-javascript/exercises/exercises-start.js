...
// 5. Skapa en funktion
// Skapa en funktion `greet` som tar ett namn som argument och skriver ut en hälsning.
...
// 8. Skapa ett objekt
// Skapa ett objekt `person` med egenskaperna `name` och `age`. Skriv ut personens namn.
